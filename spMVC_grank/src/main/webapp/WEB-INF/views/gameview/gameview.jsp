...
<link rel="stylesheet" type="text/css"
	href="${path}/resources/css/gameview.css?ver=2019111503">
<%@ include file="../include/header.jsp"%>
<title>${gDto.game_name}</title>
<div class="wrapper">
	<div class="wrapper-header">
		<span class="header-text">게임정보</span>
	</div>
	<div class="gameinfo-items">
		...
		<div class="score-items">
			...
			<div class="score">
				...
				<div class="rank-item">
					<div class="award-wrapper-header">
						<span class="award-header-text">Awards & Rankings</span>
					</div>
					<c:choose>
						<c:when test="${rList.size() > 0}">
						<c:forEach items="${rList}" var="r">
							<div class="award-content"><span style="padding-left:20px">${r}</span></div>
						</c:forEach>
						</c:when>
						<c:otherwise>
							<div class="award-content"><span style="padding-left:20px">올해 수상 경력이 없습니다.</span></div>
						</c:otherwise>
					</c:choose>
				</div>
		</div>
	...
	<div class="review-wrapper">
		<div class="creview-item">
			<div class="wrapper-header">
				<span class="header-text">Critic review : ${csize}</span>
			</div>
			<div id="c-review"></div>
			<div class="div-more">
				<a id="c_more" class="review a-button a-common">more+</a>
			</div>
			<input type="hidden" id="cview-count" value="5">
		</div>
		<div class="ureview-item">
			<div class="wrapper-header">
				<span class="header-text">User review : ${usize}</span>
			</div>
			<div id="u-review"></div>
			<div class="div-more">
				<a id="u_more" class="review a-button a-common">more+</a>
			</div>
		</div>
